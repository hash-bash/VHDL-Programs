#include "isim/work/half_adder_behhavioural_wave/testbench_arch.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        topvh = new Work_half_adder_behhavioural_wave_testbench_arch("Half_Adder_Behhavioural_Wave");
