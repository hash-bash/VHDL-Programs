#include "isim/work/full_subtrator_behavioral_wave/testbench_arch.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        topvh = new Work_full_subtrator_behavioral_wave_testbench_arch("Full_Subtrator_Behavioral_Wave");
