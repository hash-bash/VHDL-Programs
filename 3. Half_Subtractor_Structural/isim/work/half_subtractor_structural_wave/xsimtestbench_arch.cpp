#include "isim/work/half_subtractor_structural_wave/testbench_arch.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        topvh = new Work_half_subtractor_structural_wave_testbench_arch("Half_Subtractor_Structural_Wave");
