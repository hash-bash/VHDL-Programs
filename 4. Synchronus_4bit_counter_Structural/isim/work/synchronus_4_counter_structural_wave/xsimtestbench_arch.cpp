#include "isim/work/synchronus_4_counter_structural_wave/testbench_arch.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        topvh = new Work_synchronus_4_counter_structural_wave_testbench_arch("Synchronus_4_counter_Structural_Wave");
