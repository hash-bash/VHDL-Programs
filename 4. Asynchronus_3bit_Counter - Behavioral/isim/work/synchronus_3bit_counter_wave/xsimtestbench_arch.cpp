#include "isim/work/synchronus_3bit_counter_wave/testbench_arch.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        topvh = new Work_synchronus_3bit_counter_wave_testbench_arch("Synchronus_3bit_Counter_Wave");
