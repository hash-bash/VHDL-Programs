#include "isim/work/asynchronus_struc_counter_wave/testbench_arch.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        topvh = new Work_asynchronus_struc_counter_wave_testbench_arch("Asynchronus_Struc_Counter_WAVE");
